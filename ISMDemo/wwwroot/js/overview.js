var Overview = function () {    
            ...
            switch (data.statusType) {
                case "ethernet":
                    if (ethernetHasConnected != data.isConnected
                        ...
                        var logMessage = "Overview MQTT - Received message successfully. Topic: ISMDeviceStatus, \nMessage: " + message.toString();
    ...
    var handleGetMQTTMsgTimeout = function () {
        var maxTimeoutSeconds = 1;

        // If it can't receive the mqtt message after the max seconds, it will remove the loading
